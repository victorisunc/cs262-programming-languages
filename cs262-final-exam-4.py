...
test5 = """ggttt ttgggg  ttggtgg"""
print gruesome(test5) == ['ttgggg', 'ttggtgg']

test6 = """btttttb tag TakinG"""
print gruesome(test6) == ['btttttb', 'tag']

test7 = """tbbbbt gating"""
print gruesome(test7) == ['tbbbbt', 'gating']
