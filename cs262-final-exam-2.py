...
def p_list(p):
    'exp : LBRACKET numbers RBRACKET'
    p[0] = ('list', p[2])

def p_numbers(p):
    'numbers : exp COMMA numbers'
    p[0] = [p[1]] + p[3]
...
question1b = " 1 "
answer1b = ('number', 1)
print test(question1b) == answer1b

question1c = " 01 "
answer1c = ('number', 1)
print test(question1c) == answer1c

question1d = " 1 1 "
answer1d = 'error'
print test(question1d) == answer1d

question1e = " 1,1 "
answer1e = 'error'
print test(question1e) == answer1e

question1f = " (1,1 "
answer1f = 'error'
print test(question1f) == answer1f

question1g = " (1,1] "
answer1g = 'error'
print test(question1g) == answer1g
